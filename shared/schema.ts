...
export const videoTemplates = pgTable("video_templates", {
  ...
  fullStoryPrompt: text("full_story_prompt"),
  imagePrompt: text("image_prompt"),
  imageCount: integer("image_count").default(8),
  imageAssignmentPrompt: text("image_assignment_prompt"),
  ...
  captionsWordsPerTime: integer("captions_words_per_time").default(3),
