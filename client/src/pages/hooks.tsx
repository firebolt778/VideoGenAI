...
export default function Hooks() {
  ...
  const [editingTemplate, setEditingTemplate] = useState<HookTemplate | null>(
    null
  );
  ...
  const mutation = useMutation({
    mutationFn: async (data: InsertHookTemplate) => {
      const url = editingTemplate
        ? `/api/hook-templates/${editingTemplate.id}`
        : "/api/hook-templates";
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-800 mt-1">
                    Hooks are short, compelling video segments (5-15 seconds)
                    shown at the very beginning of your videos to capture viewer
                    attention. They typically include a cliffhanger, surprising
                    fact, or preview of the main content.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            {!templates || templates.length === 0 ? (
              <div className="text-center py-8 px-6">
                <p className="text-muted-foreground mb-4">
                  No hook templates found. Create your first hook template to
                  get started.
                </p>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Create compelling video hooks that capture viewer attention in the
              first few seconds
            </DialogDescription>
          </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="e.g., Mystery Cliffhanger Hook"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
